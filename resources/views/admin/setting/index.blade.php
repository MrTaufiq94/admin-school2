...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            {{-- <h4><i class="fas fa-book-open"></i> Setting</h4> --}}
        </div>
        <div class="col-sm-6">
...
{{-- <div class="alert {{ session()->get('alert-type') }} text-center"> --}}
   
    {{-- <span><strong>{{ session()->get('alert') }}</strong></span>
</div> --}}
{{-- @endif --}}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <div class="mb-3">
                        <img style="width: 100px" height="100px" src="{{ Storage::url('public/'.$s['logo']) }}" alt="">
                    </div>
